...
function RecommendationDetail() {
  ...
  const singleMonthMetrics = useSelector(
  ...
  return (
    <Container>
      ...
      >
        {" "}
        Recommendation Action Items for {getMonthName(month)} {year}{" "}
      </Typography>
      <Typography
        variant="h7"
        style={{
        ...
        sx={{ px: 15, fontStyle: "italic", fontWeight: "normal" }}
      >
        Review and check off action items for each month. Keep track of details
        in the notes!
      </Typography>
