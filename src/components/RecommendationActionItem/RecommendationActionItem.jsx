  ...
  return (
    <Container>
      {metric.variance_value === null ? (
        ...
        <Paper
          elevation={10}
          sx={{ pt: 2, m: 2, display: "flex", flexDirection: "column" }}
        >
          <Box>
            <Box
              sx={{
            ...
            >
              <Typography
                sx={{ fontSize: "10px", transform: "translate(12px, -5px)" }}
              >
                COMPLETE
              </Typography>
              <Checkbox
                ...
                value={
                  completedToggleInput === null ? "" : completedToggleInput
                }
            ...
            <Typography variant="body1" fontWeight="normal" sx={{ p: 2 }}>
              {metric.variance_value >= 0 ? (
                <>
                  {positiveText0}
                  <br />
            ...
            {metric.recommendation_ai_enhanced && (
              <Accordion>
                ...
                <AccordionDetails variant="body1" sx={{ fontWeight: "normal" }}>
                  {metric.recommendation_ai_enhanced}
                </AccordionDetails>
              </Accordion>
            )}
